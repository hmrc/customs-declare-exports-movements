...
import uk.gov.hmrc.exports.movements.services.audit.AuditTypes.Audit
...
object EventData extends Enumeration {
  ...
  val messageCode, crc, soe, roe, masterUcr, ucrType, ucr, goodsLocationCode, actionCode, errorCodes, payload, conversationId = Value
}
