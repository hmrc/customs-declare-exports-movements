...
import uk.gov.hmrc.exports.movements.migrations.MigrationRoutine
...
class RoutineRunner @Inject()(
  actorSystem: ActorSystem, applicationLifecycle: ApplicationLifecycle, migrationRoutine: MigrationRoutine
