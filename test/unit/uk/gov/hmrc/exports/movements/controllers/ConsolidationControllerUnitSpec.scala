...
class ConsolidationControllerUnitSpec extends WordSpec with MustMatchers with MockitoSugar with AuthTestSupport {
  ...
  val correctJson = AssociateDucrRequest("mucr", "ducr")
  ...
  "Consolidation Controller" should {
    ...
    "return 202 (Accepted)" when {
      ...
      "consolidation submission ends with success" in {
        ...
        val result = controller.submitConsolidation()(postRequest(correctJson))
